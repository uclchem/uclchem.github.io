...
```
    ...
    [Parallel(n_jobs=10)]: Done   2 out of   8 | elapsed:    3.0s remaining:    9.1s
    [Parallel(n_jobs=10)]: Done   3 out of   8 | elapsed:    3.0s remaining:    5.0s
...
![png](./assets/4_chemical_analysis_12_0.png)
...
![png](./assets/4_chemical_analysis_16_0.png)
